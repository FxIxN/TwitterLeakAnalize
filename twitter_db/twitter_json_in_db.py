...
with open(r'D:\projects\base\twitter.json') as tw_file:
    try:
        ...
        while tw_str:
            ...
            # query = (f"INSERT INTO test_tw(twitter_id) VALUES(" + str(tw['id']) + ");")

            query = (f"INSERT INTO accounts(twitter_id, name, location, description, followers, friends, listed, created_at, favourites, statuses, email, phone, url) VALUES(" + str(tw['id']) + "," + "'" + tw['name'] + "'" + "," + "'" + tw['location'] + "'" + "," + "'" + tw['description'] + "'" + "," + str(tw['followers_count']) + "," + str(tw['friends_count']) + "," + str(tw['listed_count']) + "," + "'" + str(tw['created_at']) + "'" + "," + str(tw['favourites_count']) + "," + str(tw['statuses_count']) + "," + "'" + tw['email'] + "'" + "," + "'" + tw['phone'] + "'" + "," + "'" + tw['url'] + "'" + ");")
